  ...
  return (
    <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50" ref={dropdownRef}>
      ...
      <motion.button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg dark:bg-gray-800 shadow-md hover:shadow-lg transition-shadow border border-gray-200 dark:border-gray-700"
        whileHover={{ scale: 1.02 }}
        whileTap={{ scale: 0.98 }}
      >
        <div className="flex items-center gap-1.5">
          <div className="w-4 h-4 rounded-full" style={{ backgroundColor: getPresetColors(preset).primary }} />
          <div className="w-4 h-4 rounded-full" style={{ backgroundColor: getPresetColors(preset).sidebar }} />
          <div className="w-4 h-4 rounded-full" style={{ backgroundColor: getPresetColors(preset).bg }} />
        </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      <div className="w-5 h-5 rounded-full border-2 border-white dark:border-gray-800 shadow-sm" 
